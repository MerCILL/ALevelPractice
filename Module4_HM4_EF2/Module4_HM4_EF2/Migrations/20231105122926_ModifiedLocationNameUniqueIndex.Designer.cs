...
namespace Module4_HM4_EF2.Migrations
{
    ...
    [Migration("20231105122926_ModifiedLocationNameUniqueIndex")]
    partial class ModifiedLocationNameUniqueIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Module4_HM4_EF2.DbData.Models.Pet", b =>
                {
                    b.HasOne("Module4_HM4_EF2.DbData.Models.Breed", "BreedEntity")
                        .WithMany("Pets")
                    ...
                    b.HasOne("Module4_HM4_EF2.DbData.Models.Category", "CategoryEntity")
                        .WithMany("Pets")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                    ...
                    b.HasOne("Module4_HM4_EF2.DbData.Models.Location", "LocationEntity")
                        .WithMany("Pets")
